...
## Examen
  ...
  On voit que pour un exercice donné, on peut un à plusieurs questions. Par contre on peut pas avoir plus de 11 exercices. Les dix premiers exercices sont obligatoires et le onzième est optionnel.
...
Ceci est le formulaire de création d'un programme de cinéma contenant toutes les informations nécéssaires relatives au film.
  ...
  On voit qu'on a la possibilité d'ajoute autant de film que l'on veut.
...
Ceci est le forumulaire de création d'un portail de restauration contenant plusieurs fiches avec les coordonnées, les menus et la carte de chaque restaurant.
  ...
  Après avoir rempli et valider notre formulaire, on est redirigé vers la page où se trouve en détails la liste des restaurants avec leurs coordonnées, leurs meunus et leur carte.
